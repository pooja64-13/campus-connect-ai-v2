...
app.post('/gemini-structured-query', async (req, res) => {
...
// Note: In Vercel serverless, this will likely only clear context for the *current*
// function invocation. For truly persistent context across multiple user requests,
// you'd need external storage (e.g., a database like Firestore).
app.post('/clear-document-context', (req, res) => {
